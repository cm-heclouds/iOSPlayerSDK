...
NSString *const ONTAudioComponentFailedToCreateNotification = @"ONTAudioComponentFailedToCreateNotification";

@interface ONTAudioCapture ()

@property (nonatomic, assign) AudioComponentInstance componetInstance;
@property (nonatomic, assign) AudioComponent component;
@property (nonatomic, strong) dispatch_queue_t taskQueue;
@property (nonatomic, assign) BOOL isRunning;
@property (nonatomic, strong, nullable) ONTLiveAudioConfiguration *configuration;

@end

@implementation ONTAudioCapture

#pragma mark -- LiftCycle
- (instancetype)initWithAudioConfiguration:(ONTLiveAudioConfiguration *)configuration{
    if(self = [super init]){
...
- (void)handleAudioComponentCreationFailure {
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:ONTAudioComponentFailedToCreateNotification object:nil];
    });
}
...
static OSStatus handleInputBuffer(void *inRefCon,
    ...
    @autoreleasepool {
        ONTAudioCapture *source = (__bridge ONTAudioCapture *)inRefCon;
        if (!source) return -1;
